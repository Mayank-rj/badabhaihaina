...
export default function Home() {
  ...
  const heroContent = [
    {
      heading: "Protect Your Home, Secure Your Future",
      para: "Safeguard your home and everything in it with our tailored insurance plans.",
      img: "/home-img/hero-sec.jpg",
      url: "home-insurance",
    },
    {
      heading: "Secure Their Future, Today.",
      para: "Choose Flexible Term Life Insurance Coverage That Grows with Your Needs.",
      img: "/home-img/hero-sec-1.jpg",
      url: "term-life-insurance",
    },
    {
      heading: "Fast, Easy, and Flexible Personal Loans for Every Need",
      para: "Get the Funds You Need in Minutes—No Hassle, No Waiting!",
      img: "/home-img/hero-sec-2.jpg",
      url: "personal-loan",
    },
    {
      heading: "Turn Your Car Dreams Into Reality.",
      para: "Hassle-Free Car Loans Backed by Trusted Financial Experts.",
      img: "/home-img/hero-sec-3.jpg",
      url: "car-loan",
    },
    {
      heading: "Your Health, Your Security – Choose the Care You Deserve",
      para: "Start your health journey today with plans designed to fit your life.",
      img: "/home-img/hero-sec-4.jpg",
      url: "health-insurance",
    },
    {
      heading: "Secure Your Financial Future with Your Property",
      para: "Unlock the Value of Your Property with Affordable Loans Today!",
